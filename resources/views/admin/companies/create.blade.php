...
<div class="mb-6">
    ...
    <p class="text-base-content/60">Cadastre uma imobiliária ou corretor</p>
</div>
        ...
        <form method="POST" action="{{ route('admin.companies.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="form-control">
                    ...
                    <input id="razao_social" type="text" name="razao_social" value="{{ old('razao_social') }}"
                ...
                <div class="form-control">
                    ...
                    <input id="nome_fantasia" type="text" name="nome_fantasia" value="{{ old('nome_fantasia') }}"
                ...
                <div class="form-control">
                    ...
                    <input id="cnpj" type="text" name="cnpj" value="{{ old('cnpj') }}"
                           class="input input-bordered w-full @error('cnpj') input-error @enderror"
                ...
                <div class="form-control">
                    ...
                    <select id="plano" name="plano" class="select select-bordered w-full">
                        <option value="gratuito" {{ old('plano') === 'gratuito' ? 'selected' : '' }}>Gratuito</option>
                        <option value="starter" {{ old('plano') === 'starter' ? 'selected' : '' }}>Starter</option>
                        <option value="pro" {{ old('plano') === 'pro' ? 'selected' : '' }}>Pro</option>
                        <option value="business" {{ old('plano') === 'business' ? 'selected' : '' }}>Business</option>
                    </select>
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="telefone" type="text" name="telefone" value="{{ old('telefone') }}"
                           class="input input-bordered w-full" placeholder="(86) 3222-0000" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="celular" type="text" name="celular" value="{{ old('celular') }}"
                           class="input input-bordered w-full" placeholder="(86) 99999-0000" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="site" type="url" name="site" value="{{ old('site') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div class="form-control">
                    ...
                    <input id="estado" type="text" name="estado" value="{{ old('estado') }}"
                           class="input input-bordered w-full" maxlength="2" placeholder="PI" />
                </div>
                ...
                <div class="form-control">
                    ...
                    <input id="cep" type="text" name="cep" value="{{ old('cep') }}"
                           class="input input-bordered w-full" placeholder="64000-000" />
                </div>
            </div>
            ...
            <div class="form-control mt-4">
                ...
                <textarea id="descricao" name="descricao" rows="3"
                          class="textarea textarea-bordered w-full">{{ old('descricao') }}</textarea>
            </div>
